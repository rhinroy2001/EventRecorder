 ...
 * @author Shai Almog
 */
public class EventRecorderStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "EventRecorder";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new EventRecorderStub());
    }
